// PROVENIÊNCIA: cópia literal de profdex-front/src/data/types.js (repo
// principal, D:\profdex\main). Não editar aqui sem editar lá — a ordem do
// TYPE_CYCLE **é** a roda de vantagens, e a landing existe para mostrar a mesma
// roda que a batalha resolve.
//
// Só foi acrescentado o `onColor()` no fim, que é assunto de apresentação e não
// existe no app.
//
...
export function legibleColor(hex, minContrast = 4.5) {
  ...
  // Luminância do --bg-deep (#121418), fixa: é o fundo de toda a página.
  const BG = 0.00603
  const int = Number.parseInt(hex.slice(1), 16)
