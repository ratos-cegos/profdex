...
const MOVE_SEEDS: Record<string, MoveSeed[]> = {
  humanas: [
    {
      ...
      raw: '85',
      description:
        'Sanção da LGPD: tratar dado pessoal sem base legal custa caro, e a multa chega de uma vez.',
      effects: [],
    },
    {
      id: 'vies-escondido',
      ...
      raw: '75 · 15% confundir',
      description:
        'Viés algorítmico: o modelo herda o preconceito dos dados e decide errado com cara de neutro.',
      effects: [confuse(0.15)],
    },
    {
      id: 'treplica-sem-do',
      name: 'Tréplica sem Dó',
      category: CATEGORY.ATAQUE,
      power: 80,
      accuracy: ACC.PADRAO,
      raw: '80 · combo',
      description:
        'Debate regrado: a tréplica fecha a argumentação em cima de tudo que já foi dito.',
      effects: [comboBonus()],
    },
    {
      id: 'dilema-do-bonde',
      name: 'Dilema do Bonde',
      category: CATEGORY.ATAQUE,
      power: 100,
      accuracy: ACC.BAIXA,
      raw: '100 · precisão baixa',
      description:
        'Experimento mental da ética: toda escolha machuca alguém, e nenhuma delas é segura.',
      effects: [],
    },
    {
      id: 'revisao-por-pares',
      ...
      raw: '-Ataque alvo',
      description:
        'Peer review: outro pesquisador confere o método e derruba o que não se sustenta.',
      effects: [debuff(STAT.RIGOR)],
    },
    {
      id: 'direito-de-resposta',
      ...
      raw: 'reflete',
      description:
        'Direito de resposta: a acusação volta para quem fez, na mesma proporção em que saiu.',
    ...
    },
    {
      ...
      raw: 'dano/turno',
      description:
        'Termo de uso que ninguém lê: a cláusula escondida vai cobrando o preço a cada turno.',
      effects: [dot()],
    },
    {
      id: 'roda-de-conversa',
      ...
      description:
        'Escuta ativa: parar para ouvir o grupo desfaz o mal-entendido e devolve o fôlego.',
  ...
  'engenharia-software': [
    {
      id: 'escopo-que-cresceu',
      name: 'Escopo que Cresceu',
      category: CATEGORY.ATAQUE,
      power: 35,
      accuracy: ACC.PADRAO,
      raw: 'cresce/turno',
      description:
        'Scope creep: o escopo incha a cada reunião e o estrago cresce junto com ele.',
      effects: [grow(15)],
    },
    {
      id: 'juros-da-divida-tecnica',
      name: 'Juros da Dívida Técnica',
      category: CATEGORY.ATAQUE,
      power: 110,
      accuracy: ACC.PADRAO,
      raw: '110 · recuo',
      description:
        'Dívida técnica: a gambiarra de ontem cobra juros hoje, e quem escreveu paga junto.',
      effects: [recoil(0.25)],
    },
    {
      id: 'review-da-sprint',
      name: 'Review da Sprint',
      category: CATEGORY.ATAQUE,
      power: 85,
      accuracy: ACC.PADRAO,
      raw: '85 · combo',
      description:
        'Sprint review: o time mostra o incremento pronto e cada entrega anterior soma no total.',
      effects: [comboBonus()],
    },
    {
      id: 'requisito-de-ultima-hora',
      name: 'Requisito de Última Hora',
      category: CATEGORY.ATAQUE,
      power: 90,
      accuracy: ACC.PADRAO,
      raw: '90 · 15% travar',
      description:
        'Mudança de requisito no fim do ciclo: chega sem aviso e pode travar o time inteiro.',
      effects: [paralyze(0.15)],
    },
    {
      id: 'diagrama-de-classes',
      ...
      raw: '+Defesa',
      description:
        'Modelagem em UML: a estrutura desenhada antes de codar é o que sustenta o sistema.',
      effects: [buff(STAT.DIDATICA)],
    },
    {
      id: 'levantou-os-requisitos',
      name: 'Levantou os Requisitos',
      category: CATEGORY.BUFF,
      power: null,
      accuracy: 1,
      raw: '+Ataque/turno',
      description:
        'Elicitação de requisitos: entender o problema de verdade faz o ataque acertar o alvo certo.',
      effects: [growPerTurn(STAT.RIGOR)],
    },
    {
      id: 'reuniao-que-podia-ser-email',
      name: 'Reunião que Podia Ser E-mail',
      category: CATEGORY.DEBUFF,
      power: null,
      accuracy: 1,
      raw: '-Velocidade alvo',
      description:
        'Cerimônia mal dimensionada: consome a hora do time e atrasa a entrega do adversário.',
      effects: [debuff(STAT.RACIOCINIO)],
    },
    {
      id: 'refatorou-geral',
      name: 'Refatorou Geral',
      category: CATEGORY.CURA,
      power: null,
      accuracy: 1,
      raw: '+Cafeína/stats',
      description:
        'Refatoração: reescreve sem mudar o comportamento, paga a dívida e recupera o fôlego.',
      effects: [heal(0.25), resetDebuffs()],
    },
  ],
